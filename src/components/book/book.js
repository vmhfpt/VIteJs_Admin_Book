...
export default async function  Book(){
    const dataItem = await bookService.index();
    var idDelete = 0;
      ...
      window.handleDelete = (thisData) => {
          ...
          .then((data) => {
                if(data.status == 'success'){
                  $('#exampleModal').modal('toggle');
                  $('#exampleModalLabelCustom').text(`Delete book successfully`);
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Home/</span> List Books
      </h4>

      <div class="card">
        <h5 class="card-header">Manager books</h5>
        <div class="table-responsive text-nowrap">
          <table class="table">
            ...
            ${dataItem.map((item, key) => (
                ...
                <td>${item.title}</td>
                <td><img style="width : 120px ; height : 140px; object-fit : cover" src="${item.image}"  /> </td>
                <td>${item.author}</td>
                ...
                <td>
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item btn-edit-handle" href="/book/edit/${item.id}" data-navigo><i class="bx bx-edit-alt me-1"></i> Edit</a>
      ...
      <div class="my-3">
        <div class="demo-inline-spacing">
          ...
          <a  href="/book/add" class="" data-navigo> <button type="button" class="btn btn-success add-handle ">Add book</button></a>
